...
const MyBookings = () => {
  ...
  const fetchUserBookings = async () => {
    try {
      ...
      console.error("Fetch Bookings Failed (using Demo Data):", error);
      setBookings(userBookingsDummyData);
    }
  }
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title align="left" title='My Bookings' subTitle='Easily manage your past, current and upcoming hotel reservations
        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            <div className='flex flex-col md:flex-row'>
              <img src={booking.room.images && booking.room.images.length > 0 ? booking.room.images[0] : assets.hotelPlaceholder || 'https://via.placeholder.com/400x300'} alt="hotel-img"
