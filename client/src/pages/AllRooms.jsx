        ...
        {filteredRooms.map((room) => (
          <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b
            ...
            <img onClick={() => { navigate(`/rooms/${room._id}`); scrollTo(0, 0) }}
              src={room.images && room.images.length > 0 ? room.images[0] : assets.hotelPlaceholder || 'https://via.placeholder.com/400x300?text=Hotel+Image'} alt="hotel-img" title='View Room Details'
