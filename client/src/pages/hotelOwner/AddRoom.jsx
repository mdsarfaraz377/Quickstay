  ...
  const onSubmitHandler = async (e) => {
    ...
    if(!inputs.roomType || !inputs.pricePerNight || !inputs.amenities ||
      ...
      try{
        ...
        // convert ammenities to array and keep only enabled amenities
    ...
    <form onSubmit={onSubmitHandler}>
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully
       ...
       <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w48'>
          ...
          className='border opacity-70 border-gray-300 mt-1 rounded p-2 '>
            <option type="value">Select Room Type</option>
            <option type="Single Room">Single Room</option>
            <option type="Double Room">Double Room</option>
            <option type="Luxury Room">Luxury Room</option>
            <option type="Family Suite">Family Suite</option>
          </select>
        </div>
       ...
       <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm '>
        ...
        <div className='gap-4'>
          <button type="submit" className='bg-primary text-white px-4 py-0.5 rounded mt-1/2 cursor-pointer gap-10 '
            disabled={loading}>
