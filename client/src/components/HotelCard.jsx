...
const HotelCard = ({ room, index }) => {
  return (
    <Link to={'/rooms/' + room._id}
      ...
      <img
        src={room.images && room.images.length > 0 ? room.images[0] : assets.hotelPlaceholder || 'https://via.placeholder.com/400x300?text=Hotel+Image'}
        alt={room.hotel?.name || 'Hotel'}
        className='w-full h-64 object-cover'
        onError={(e) => { e.target.src = 'https://via.placeholder.com/400x300?text=Hotel+Image' }}
      />
