...
const Hero = () => {
  ...
  const onSearch = async (e) => {
    ...
    setSearchedCities((preventSearchedCities) => {
      const updatedSearchedCities = [...preventSearchedCities, destination]
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6
       ...
       bg-no-repeat bg-cover bg-center h-screen' style={{ backgroundImage: `url(${assets.heroImage})` }}>

      <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>The Ultimate Hotel Experience</p>
      <h1 className='font-playfair text-2xl md:text-5x md:text-[56px]
