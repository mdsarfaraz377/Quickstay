...
const HotelReg = () => {
  ...
  const { axios, setIsOwner, setShowHotelReg } = useAppContext();
  ...
  const onSubmitHandler = async (event) => {
    try {
      ...
      //const token = await getToken(); // get token string
      ...
      //console.error(error); // see full error in console
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4'>
                ...
                <input id='name' onChange={ (e) => setName(e.target.value)} value={name}
                 type="text" placeholder="Taj Hotel" 
            ...
            <div className='w-full mt-4'>
                ...
                id="contact" type="text" placeholder="+1-xxxxxx" 
                    className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1
                     outline-indigo-500 font-light" required
                />
            </div>
            ...
            <div className='w-full mt-4'>
                ...
                <input onChange={ (e)=> setAddress(e.target.value)} value={address}
                    id="address" type="text" placeholder="Texas" 
                    className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1
                     outline-indigo-500 font-light" required
                />
            </div>
